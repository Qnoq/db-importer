  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-black transition-colors duration-200">
    <div class="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <div class="rounded-2xl shadow-xl dark:shadow-2xl dark:shadow-neon-green-500/10 overflow-hidden mb-8 border transition-all duration-200" style="background: var(--p-surface-0); border-color: var(--p-surface-border)">
        ...
        <div class="bg-neon-green-50 dark:bg-neon-green-950/20 border-l-4 border-neon-green-500 dark:border-neon-green-400 p-6 m-6">
          <div class="flex items-start">
            <i class="pi pi-shield text-neon-green-600 dark:text-neon-green-400 text-2xl mr-4 mt-1"></i>
            <div>
              <h3 class="text-lg font-bold text-neon-green-900 dark:text-neon-green-300 mb-2">🔒 Our Privacy Commitment</h3>
              <p class="text-neon-green-900 dark:text-neon-green-300 font-semibold mb-2">
                <strong>Key Privacy Principle:</strong> We do NOT access, connect to, or store data from your actual databases.
              </p>
              <p class="text-neon-green-900 dark:text-neon-green-300">
        ...
        <div class="prose prose-green max-w-none px-8 py-6">
          <section class="mb-10">
            <h2 class="text-3xl font-bold mb-4 pb-2 border-b-2 border-neon-green-600 dark:border-neon-green-500" style="color: var(--p-text-color)">1. Introduction</h2>
          ...
          <section class="mb-10">
            <h2 class="text-3xl font-bold mb-4 pb-2 border-b-2 border-neon-green-600 dark:border-neon-green-500" style="color: var(--p-text-color)">2. Information We Collect</h2>

          <h3 class="text-xl font-semibold mb-3" style="color: var(--p-text-color) mt-4">2.1 Personal Information</h3>
          ...
          <h3 class="text-xl font-semibold mb-3" style="color: var(--p-text-color) mt-4">2.2 Uploaded Files and Processing</h3>
          <p style="color: var(--p-text-color)" mb-4">
          ...
          <h3 class="text-xl font-semibold mb-3" style="color: var(--p-text-color) mt-4">2.3 Import History Metadata (Registered Users Only)</h3>
          <p style="color: var(--p-text-color)" mb-4">
          ...
          <h3 class="text-xl font-semibold mb-3" style="color: var(--p-text-color) mt-4">2.4 Technical and Usage Information</h3>
          <p style="color: var(--p-text-color)" mb-4">
          ...
          <section class="mb-10">
            <h2 class="text-3xl font-bold mb-4 pb-2 border-b-2 border-neon-green-600 dark:border-neon-green-500" style="color: var(--p-text-color)">3. How We Use Your Information</h2>
          <p style="color: var(--p-text-color)" mb-4">
          ...
          <section class="mb-10">
            <h2 class="text-3xl font-bold mb-4 pb-2 border-b-2 border-neon-green-600 dark:border-neon-green-500" style="color: var(--p-text-color)">4. Data Storage and Security</h2>

          <h3 class="text-xl font-semibold mb-3" style="color: var(--p-text-color) mt-4">4.1 Security Measures</h3>
          <p style="color: var(--p-text-color)" mb-4">
          ...
          <h3 class="text-xl font-semibold mb-3" style="color: var(--p-text-color) mt-4">4.2 Data Storage</h3>
          <p style="color: var(--p-text-color)" mb-4">
          ...
          <h3 class="text-xl font-semibold mb-3" style="color: var(--p-text-color) mt-4">4.3 Third-Party Infrastructure</h3>
          <p style="color: var(--p-text-color)" mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4" style="color: var(--p-text-color)">5. Data Retention</h2>
          <p style="color: var(--p-text-color)" mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4" style="color: var(--p-text-color)">6. Sharing of Information</h2>
          <p style="color: var(--p-text-color)" mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4" style="color: var(--p-text-color)">7. Your Data Rights</h2>
          <p style="color: var(--p-text-color)" mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4" style="color: var(--p-text-color)">8. Cookies and Tracking Technologies</h2>
          <p style="color: var(--p-text-color)" mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4" style="color: var(--p-text-color)">9. Third-Party Services</h2>
          <p style="color: var(--p-text-color)" mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4" style="color: var(--p-text-color)">10. Children's Privacy</h2>
          <p style="color: var(--p-text-color)" mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4" style="color: var(--p-text-color)">11. International Data Transfers</h2>
          <p style="color: var(--p-text-color)" mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4" style="color: var(--p-text-color)">12. Changes to This Privacy Policy</h2>
          <p style="color: var(--p-text-color)" mb-4">
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4" style="color: var(--p-text-color)">13. GDPR Compliance (EU Users)</h2>
          <p style="color: var(--p-text-color)" mb-4">
          ...
          <section class="mb-10">
            <h2 class="text-3xl font-bold mb-4 pb-2 border-b-2 border-neon-green-600 dark:border-neon-green-500" style="color: var(--p-text-color)">14. Contact Us</h2>
            <p style="color: var(--p-text-color)" text-lg mb-4">
        ...
        <div class="bg-gradient-to-r from-gray-50 to-neon-green-50 dark:from-gray-900 dark:to-gray-800 px-8 py-6 border-t border-gray-200">
          <router-link to="/" class="inline-flex items-center text-neon-green-600 dark:text-neon-green-400 hover:text-neon-green-900 dark:text-neon-green-300 font-semibold transition-colors">
