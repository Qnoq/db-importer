    ...
    <div class="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <div class="rounded-2xl shadow-xl dark:shadow-2xl dark:shadow-neon-green-500/10 overflow-hidden mb-8 border transition-all duration-200" style="background: var(--p-surface-0); border-color: var(--p-surface-border)">
        ...
        <div class="prose prose-green max-w-none px-8 py-6">
          ...
          <h3 class="text-xl font-semibold mb-3 mt-4" style="color: var(--p-text-color)">2.1 Personal Information</h3>
          ...
          <h3 class="text-xl font-semibold mb-3 mt-4" style="color: var(--p-text-color)">2.2 Uploaded Files and Processing</h3>
          <p class="mb-4" style="color: var(--p-text-color)">
          ...
          <h3 class="text-xl font-semibold mb-3 mt-4" style="color: var(--p-text-color)">2.3 Import History Metadata (Registered Users Only)</h3>
          <p class="mb-4" style="color: var(--p-text-color)">
          ...
          <h3 class="text-xl font-semibold mb-3 mt-4" style="color: var(--p-text-color)">2.4 Technical and Usage Information</h3>
          <p class="mb-4" style="color: var(--p-text-color)">
          ...
          <h3 class="text-xl font-semibold mb-3 mt-4" style="color: var(--p-text-color)">4.1 Security Measures</h3>
          <p class="mb-4" style="color: var(--p-text-color)">
          ...
          <h3 class="text-xl font-semibold mb-3 mt-4" style="color: var(--p-text-color)">4.2 Data Storage</h3>
          <p class="mb-4" style="color: var(--p-text-color)">
          ...
          <h3 class="text-xl font-semibold mb-3 mt-4" style="color: var(--p-text-color)">4.3 Third-Party Infrastructure</h3>
          <p class="mb-4" style="color: var(--p-text-color)">
